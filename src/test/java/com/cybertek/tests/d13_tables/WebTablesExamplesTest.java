...
/**
 * WEBTABLES
 * In html tables are represented with <table> tag Tables are (usually) made of <thead> and <tbody>.
 * <thead>. —> this is the table header, here we have the table column names <th> —> this tag indicates a cell that is used for table headers.
 * <tbody> —> this is where the data is.
 * <tr> —> table row, indicates one whole row
 * <td> —> cell in a table body //table[@id='table1']/tbody/tr[ 1]
 * Find cell (cell 2) in a table in relation to other cell (cell 1) in same row: 1. Find cell 1
 * //table[@id=‘table1']//td[.='Jason']
 * Find the table. Then find a cell with certain text in that table. 2. Find the row where cell 1 is
 * //table[@id=‘table1']//td[.='Jason']/..
